...
public class CategorizadorDeProdutos {
    public static void main(String[] args) {
        var leitor = new Scanner(System.in);
            ...
            System.out.println("Digite as categorias:");
        ...
        while (true) {
            ...
            var system = """
                    Você é um categorizador de produtos e deve responder apenas o nome da categoria do produto informado pelo usuário.
                    ...
                    Caso o usuário pergunte algo que nao seja de categorizacao de produtos, voce deve responder que nao pode ajudar pois o seu papel é responder a categoria dos produtos.
