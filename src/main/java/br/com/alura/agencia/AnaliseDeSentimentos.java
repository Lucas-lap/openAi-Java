...
public class AnaliseDeSentimentos {
    ...
    private static String enviarRequisicao(Path arquivo) throws InterruptedException {
        ...
        var promptSistema = """
                Você é um analisador de sentimentos de avaliações de viagens.
                Escreva um parágrafo com até 20 palavras resumindo as avaliações e depois atribua qual o sentimento geral para a viagem.
                Identifique também até 3 pontos fortes e até 3 pontos fracos identificados a partir das avaliações.
                                
                #### Formato de saída
                Nome do destino[local da viagem]:
                Resumo das avaliações: [resuma em até 20 palavras]
                Sentimento geral: [deve ser: POSITIVO, NEUTRO ou NEGATIVO]
                Pontos fortes: [até 3 bullets points]
                Pontos fracos: [até 3 bullets points]
                """;
